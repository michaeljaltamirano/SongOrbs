...
export const song = function(window) {
  ...
  setTimeout(function(){ qAnimation.play(); }, 0);
  setTimeout(function(){ wAnimation.play(); }, 12000);
  setTimeout(function(){ wAnimation2.play(); }, 18000);
  setTimeout(function(){ wAnimation3.play(); }, 24000);
  setTimeout(function(){ uAnimation.play(); }, 24000);
  setTimeout(function(){ wAnimation4.play(); }, 30000);
  setTimeout(function(){ lAnimation.play(); }, 36000);
  setTimeout(function(){ iAnimation.play(); }, 43000);
};
